...
function FileTree({ store, routeBase, rootPrefix = "", extraTexty, title, className, style, markdownRenderer, parquetRenderer, jsonRenderer }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className, style, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Body, { store, parsed, routeBase, rootPrefix, markdownRenderer, parquetRenderer, jsonRenderer })
  ] });
}
