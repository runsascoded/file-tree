...
function Breadcrumb({ crumbs, separator = " / ", rightSlot, renderCrumb }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", { "aria-label": "Breadcrumb", style: { fontFamily: "ui-monospace, monospace", fontSize: "0.95em", marginBottom: "0.5em" }, children: [
    crumbs.map((c, i) => {
      ...
      const defaultNode = isLast ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { opacity: 0.7 }, children: c.label }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_router_dom.Link, { to: c.to, children: c.label });
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("table", { style: { borderCollapse: "collapse", width: "100%" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("tbody", { children: filtered.map((e) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("tr", { style: { borderTop: "1px solid rgba(127,127,127,0.2)" }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("td", { style: { padding: "0.3em 0.6em", textAlign: "right", fontVariantNumeric: "tabular-nums", opacity: e.isDir ? 0.4 : 1 }, children: cell("size", e.isDir ? "\u2014" : fmtSize(e.size)) }),
