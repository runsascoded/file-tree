...
function FileTree({ store, routeBase, rootPrefix = "", extraTexty, title, className, style, markdownRenderer, parquetRenderer, jsonRenderer }) {
  ...
  return /* @__PURE__ */ jsxs5("div", { className, style, children: [
    title && /* @__PURE__ */ jsx5("h1", { style: { fontSize: "1.4em", margin: "0 0 0.3em" }, children: title }),
    /* @__PURE__ */ jsx5(
      Breadcrumb,
      {
        crumbs,
...
function Body({ store, parsed, routeBase, rootPrefix, markdownRenderer, parquetRenderer, jsonRenderer }) {
  switch (parsed.kind) {
    ...
    case "zip":
    case "zipEntry":
      return /* @__PURE__ */ jsx5(UnsupportedView, { label: "Zip preview" });
    case "parquet": {
      if (!parquetRenderer) return /* @__PURE__ */ jsx5(UnsupportedView, { label: "Parquet preview" });
    ...
    case "binary":
      return /* @__PURE__ */ jsx5("div", { style: { opacity: 0.7 }, children: "Preview not supported for this file type." });
  }
}
...
function UnsupportedView({ label }) {
  return /* @__PURE__ */ jsxs5("div", { style: { opacity: 0.7 }, children: [
    label,
