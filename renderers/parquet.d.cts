...
import { P as ParquetColumn, a as ParquetColumnStats } from '../parquetData-CQjjd2Cb.cjs';
export { N as NUMERIC_TYPES, b as ParquetMeta, R as RG_CACHE_SIZE, c as RowGroupInfo, T as TemporalColumn, d as TemporalFormat, e as TemporalPrecision, f as TemporalSource, g as TemporalUnit, h as coarseKind, i as formatTemporal, j as inferColumnFormats, k as inferTemporalFormat, t as toMillis, u as useParquetMeta, l as useRowGroup } from '../parquetData-CQjjd2Cb.cjs';
import { P as PersistedState } from '../persistedState-CB_wfbcb.cjs';
import { b as TableCellCtx, c as TableCellRenderer, d as TableColumnProps, e as TableHeaderCtx, T as TableViewerOptions } from '../table-ZN60aKsl.cjs';
export { a as TableColumn, f as TableHeaderRenderer } from '../table-ZN60aKsl.cjs';
...
declare function ParquetViewer({ store, path, usePersistedState, renderCell, renderHeader, cellProps, headerProps, inferTimestamps, alignNumeric, columnPicker, hiddenColumns, fullLoadMaxBytes, sortComparators, onPage, onCellHover }: {
    store: Store;
    path: string;
    usePersistedState?: PersistedState;
} & ParquetViewerOptions): react_jsx_runtime.JSX.Element;
