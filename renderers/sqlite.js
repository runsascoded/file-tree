...
function SqliteViewer({
  ...
  const [db, setDb] = useState5(null);
  const [objects, setObjects] = useState5(null);
  ...
  const catalog = useMemo5(
    () => db ? sqliteCatalog(db, countRows === void 0 ? {} : { countRows }) : null,
    [db, countRows]
  );
  if (error) {
    return /* @__PURE__ */ jsxs4("div", { style: { color: "crimson", fontSize: "0.9em" }, children: [
      /* @__PURE__ */ jsx6("strong", { children: "SQLite:" }),
      " ",
      error.message
    ] });
  }
  if (!catalog || !objects) return /* @__PURE__ */ jsx6("div", { style: { opacity: 0.6 }, children: "opening database\u2026" });
  return /* @__PURE__ */ jsx6(
    TableBrowser,
    {
      ...
      ...showStats && db ? {
        status: /* @__PURE__ */ jsxs4("span", { style: { opacity: 0.5, fontSize: "0.9em" }, title: "ranged reads / cache hits", children: [
          db.stats.reads,
          " reads \xB7 ",
          db.stats.hits,
          " cached"
