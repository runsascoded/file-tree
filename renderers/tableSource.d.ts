...
interface TableSourceCapabilities {
...
interface PageResult<C extends TableColumn = TableColumn> {
...
interface TableSource<C extends TableColumn = TableColumn> {
 ...
 */
interface TableCatalog<C extends TableColumn = TableColumn> {
 ...
 *  from a string. */
declare function kindOfDeclaredType(declared: string): TableColumn['kind'];

export { type PageRequest, type PageResult, type TableCatalog, type TableObject, type TableSource, type TableSourceCapabilities, kindOfDeclaredType };
