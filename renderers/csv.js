...
function makeCsvViewer(opts = {}) {
  return function BoundCsvViewer(props) {
    return /* @__PURE__ */ jsx5(CsvViewer, { ...props, ...opts });
  };
}
function CsvViewer({ store, path, delimiter, usePersistedState, renderCell, renderHeader, cellProps, headerProps, columnPicker = false, hiddenColumns, fullLoadMaxBytes = DEFAULT_FULL_LOAD_MAX_BYTES, sortComparators, ditto, onPage, onCellHover, elide, resizableColumns = false }) {
  ...
  return /* @__PURE__ */ jsxs3(Fragment, { children: [
    /* @__PURE__ */ jsxs3("p", { style: { opacity: 0.7, fontSize: "0.95em", margin: "0 0 0.6em", position: "relative", zIndex: 2 }, children: [
      /* @__PURE__ */ jsx5("b", { children: allColumns.length }),
      " columns",
      smallTable && rows ? /* @__PURE__ */ jsxs3(Fragment, { children: [
        " \xB7 ",
        /* @__PURE__ */ jsx5("b", { children: rows.length.toLocaleString() }),
        " rows"
      ] }) : null,
      " ",
      "\xB7 ",
      fmtSize(total),
      columnPicker && /* @__PURE__ */ jsxs3(Fragment, { children: [
        " \xB7 ",
        /* @__PURE__ */ jsx5(ColumnPicker, { columns: allColumns, vis: { visible, ...vis } })
      ] })
    ] }),
    smallTable && /* @__PURE__ */ jsx5("p", { style: { opacity: 0.8, fontSize: "0.9em", margin: "0 0 0.5em" }, children: /* @__PURE__ */ jsx5(
      FilterInput,
      {
        value: filter,
        onChange: setFilter,
    ...
    !smallTable && /* @__PURE__ */ jsxs3("p", { style: { opacity: 0.6, fontSize: "0.85em", margin: "0 0 0.4em" }, children: [
      fmtSize(total),
      " \u2014 streaming byte ranges; sorting needs the whole file."
    ] }),
    pages > 1 && /* @__PURE__ */ jsxs3("div", { style: { display: "flex", alignItems: "center", gap: "0.5em", margin: "0.4em 0", fontSize: "0.9em", flexWrap: "wrap" }, children: [
      /* @__PURE__ */ jsx5("button", { disabled: page === 0, onClick: () => setPage(0), children: "\xAB" }),
      /* @__PURE__ */ jsx5("button", { disabled: page === 0, onClick: () => setPage(page - 1), children: "\u2039" }),
      /* @__PURE__ */ jsxs3("span", { style: { opacity: 0.8 }, children: [
        "page ",
        /* @__PURE__ */ jsx5("b", { children: page + 1 }),
        " / ",
      ...
      /* @__PURE__ */ jsx5("button", { disabled: page === pages - 1, onClick: () => setPage(page + 1), children: "\u203A" }),
      /* @__PURE__ */ jsx5("button", { disabled: page === pages - 1, onClick: () => setPage(pages - 1), children: "\xBB" })
    ] }),
    /* @__PURE__ */ jsx5("div", { style: { overflowX: "auto", maxHeight: "70vh", overflowY: "auto", border: "1px solid rgba(127,127,127,0.3)", borderRadius: 4 }, children: /* @__PURE__ */ jsxs3("table", { style: { borderCollapse: "collapse", fontSize: "0.82em", fontFamily: "ui-monospace, monospace" }, children: [
      /* @__PURE__ */ jsx5("thead", { children: /* @__PURE__ */ jsx5("tr", { style: { position: "sticky", top: 0, zIndex: 1, background: "Canvas" }, children: columns.map((c) => {
        ...
        return /* @__PURE__ */ jsxs3("th", { style: { ...st?.header ?? TH_STYLE, whiteSpace: "nowrap", ...resizableColumns ? { position: "relative" } : {}, ...cw.styleFor(c.name) }, className: st?.headerClass, children: [
