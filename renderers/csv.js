...
function CsvViewer({ store, path, delimiter, usePersistedState, renderCell, renderHeader, cellProps, headerProps, columnPicker = false, hiddenColumns }) {
  ...
  const allColumns = useMemo2(() => (header ?? []).map((name) => ({ name })), [header]);
  const { visible, ...vis } = useColumnVisibility(allColumns, usePersistedState, hiddenColumns);
  const columns = useMemo2(() => allColumns.filter((c) => visible.includes(c.name)), [allColumns, visible]);
  const colIndex = useMemo2(
  ...
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx2("div", { style: { overflowX: "auto", maxHeight: "70vh", overflowY: "auto", border: "1px solid rgba(127,127,127,0.3)", borderRadius: 4 }, children: /* @__PURE__ */ jsxs2("table", { style: { borderCollapse: "collapse", fontSize: "0.82em", fontFamily: "ui-monospace, monospace" }, children: [
      /* @__PURE__ */ jsx2("thead", { children: /* @__PURE__ */ jsx2("tr", { style: { position: "sticky", top: 0, zIndex: 1, background: "Canvas" }, children: columns.map((c) => {
        ...
        return /* @__PURE__ */ jsx2("th", { style: { ...st?.header ?? TH_STYLE, whiteSpace: "nowrap" }, className: st?.headerClass, children: renderHeader ? renderHeader({ column: c, path, defaultNode: c.name }) : c.name }, c.name);
      }) }) }),
