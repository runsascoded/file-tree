...
function renderJsonTree(source, usePersistedState) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(JsonViewer, { source, usePersistedState });
}
function JsonViewer({ source, usePersistedState }) {
  ...
  const [forceOpen, setForceOpen] = (0, import_react2.useState)(null);
...
function Node({ value, path, q, matches, forceOpen, forceOpenVersion, initialOpen, copyPath }) {
  ...
  if (Array.isArray(value)) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrayNode, { value, path, q, matches, forceOpen, forceOpenVersion, initialOpen: initialOpen ?? false, copyPath });
  }
  if (typeof value === "object") {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ObjectNode, { value, path, q, matches, forceOpen, forceOpenVersion, initialOpen: initialOpen ?? false, copyPath });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
    ...
    open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginLeft: INDENT }, children: value.map((v, i) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Node, { value: v, path: childPath, q, matches, forceOpen, forceOpenVersion, copyPath }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
    ...
    open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginLeft: INDENT }, children: keys.map((k, i) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: COLORS.punct }, children: ": " }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Node, { value: value[k], path: childPath, q, matches, forceOpen, forceOpenVersion, copyPath }),
