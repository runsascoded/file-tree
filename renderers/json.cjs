...
function renderJsonTree(source) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontFamily: FONT, fontSize: "0.85em", overflowX: "auto", maxHeight: "80vh" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Node, { value, initialOpen: true }) });
}
function Node({ value, initialOpen = false }) {
  ...
  if (typeof value === "string") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: COLORS.string }, children: [
    '"',
    value,
    '"'
  ] });
  ...
  if (Array.isArray(value)) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrayNode, { value, initialOpen });
  if (typeof value === "object") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ObjectNode, { value, initialOpen });
...
function ArrayNode({ value, initialOpen }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
    ...
    open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginLeft: INDENT }, children: value.map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Node, { value: v }),
      i < value.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: COLORS.punct }, children: "," })
    ] }, i)) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: COLORS.punct, opacity: 0.7 }, children: [
      " ",
      value.length,
      " items "
    ] }),
...
function ObjectNode({ value, initialOpen }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toggle, { open, onClick: () => setOpen((o) => !o) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: COLORS.punct }, children: "{" }),
    open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginLeft: INDENT }, children: keys.map((k, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: COLORS.key }, children: [
        '"',
        k,
        '"'
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: COLORS.punct }, children: ": " }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Node, { value: value[k] }),
      i < keys.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: COLORS.punct }, children: "," })
    ] }, k)) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: COLORS.punct, opacity: 0.7 }, children: [
      " ",
      keys.length,
      " keys "
    ] }),
