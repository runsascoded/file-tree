...
function RemoteTableViewer({
  ...
  if (error) {
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { color: "crimson", fontSize: "0.9em" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: "Tables:" }),
      " ",
      error.message
    ] });
  }
  if (!objects) return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { opacity: 0.6 }, children: "loading tables\u2026" });
