...
function RemoteTableViewer({
  ...
  if (error) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { color: "crimson", fontSize: "0.9em" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: "Tables:" }),
      " ",
      error.message
    ] });
  }
  if (!objects) return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { opacity: 0.6 }, children: "loading tables\u2026" });
