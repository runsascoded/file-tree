...
// src/test/treeConformance.ts
var treeConformance_exports = {};
__export(treeConformance_exports, {
  runTreeSourceConformance: () => runTreeSourceConformance
});
module.exports = __toCommonJS(treeConformance_exports);
...
function requireReactIs_production_min() {
  ...
  var b = /* @__PURE__ */ Symbol.for("react.element"), c = /* @__PURE__ */ Symbol.for("react.portal"), d2 = /* @__PURE__ */ Symbol.for("react.fragment"), e = /* @__PURE__ */ Symbol.for("react.strict_mode"), f4 = /* @__PURE__ */ Symbol.for("react.profiler"), g = /* @__PURE__ */ Symbol.for("react.provider"), h3 = /* @__PURE__ */ Symbol.for("react.context"), k2 = /* @__PURE__ */ Symbol.for("react.server_context"), l2 = /* @__PURE__ */ Symbol.for("react.forward_ref"), m3 = /* @__PURE__ */ Symbol.for("react.suspense"), n2 = /* @__PURE__ */ Symbol.for("react.suspense_list"), p4 = /* @__PURE__ */ Symbol.for("react.memo"), q = /* @__PURE__ */ Symbol.for("react.lazy"), t = /* @__PURE__ */ Symbol.for("react.offscreen"), u2;
...
var ASYMMETRIC_MATCHERS_OBJECT = /* @__PURE__ */ Symbol.for(
...
var AsymmetricMatcher3 = class {
  ...
  [/* @__PURE__ */ Symbol.for("chai/inspect")](options) {
...
// node_modules/.pnpm/vitest@2.1.9/node_modules/vitest/dist/chunks/utils.C8RiOc4B.js
...
// node_modules/.pnpm/vitest@2.1.9/node_modules/vitest/dist/chunks/_commonjsHelpers.BFTU3MAI.js
...
// node_modules/.pnpm/vitest@2.1.9/node_modules/vitest/dist/chunks/date.W2xKR2qe.js
var RealDate = Date;
var now2 = null;
...
// node_modules/.pnpm/vitest@2.1.9/node_modules/vitest/dist/chunks/vi.DgezovHB.js
var unsupported = [
...
// node_modules/.pnpm/vitest@2.1.9/node_modules/vitest/dist/index.js
var import_expect_type = __toESM(require_dist(), 1);

// src/test/conformance.ts
var CONFORMANCE_FIXTURE = {
  "README.md": "# fixture\n\nTop-level readme.\n",
...
var KEYS = Object.keys(CONFORMANCE_FIXTURE);
function filesUnder(path2) {
  const p4 = path2 ? `${path2}/` : "";
  return KEYS.filter((k2) => k2.startsWith(p4) && k2.length > p4.length);
}
function sizeUnder(path2) {
  return filesUnder(path2).reduce((s, k2) => s + byteLen(CONFORMANCE_FIXTURE[k2]), 0);
}
function immediateChildren(path2) {
  const p4 = path2 ? `${path2}/` : "";
  const seen = /* @__PURE__ */ new Map();
  for (const k2 of KEYS) {
    if (!k2.startsWith(p4) || k2.length <= p4.length) continue;
    const rest = k2.slice(p4.length);
    const slash2 = rest.indexOf("/");
    if (slash2 >= 0) seen.set(rest.slice(0, slash2), "dir");
    else seen.set(rest, "file");
  }
  return [...seen].map(([name, kind]) => ({ name, kind }));
}
function tuple(n2) {
  return { path: n2.path, name: n2.name, kind: n2.kind, size: n2.size };
}
var byPath = (xs) => [...xs].sort((a3, b) => a3.path.localeCompare(b.path));
function runTreeSourceConformance(makeSource, opts = {}) {
  ...
  describe("TreeSource conformance", () => {
    it("root size is the sum of every file in the tree", async () => {
      ...
      globalExpect(tuple(node)).toEqual({
        path: "",
        name: rootLabel,
        kind: "dir",
        size: sizeUnder("")
    ...
    it("lists exactly the immediate children, each with its rollup", async () => {
      ...
      globalExpect(byPath(children.map(tuple))).toEqual(byPath(expected));
    });
    it("every interior directory rolls up its own subtree", async () => {
      const src = await makeSource();
      for (const path2 of ["docs", "docs/guide", "data", "data/2024"]) {
        const { node, children } = await src.children({ path: path2 });
        globalExpect(tuple(node)).toEqual({
          path: path2,
          name: path2.split("/").pop(),
          kind: "dir",
          size: sizeUnder(path2)
        });
        const childSum = children.reduce((s, c) => s + (c.size ?? 0), 0);
        globalExpect(childSum).toBe(sizeUnder(path2));
      }
    });
    it("reports the immediate-child count on each directory", async () => {
      const src = await makeSource();
      for (const path2 of ["", "docs", "data", "data/2024"]) {
        const { node } = await src.children({ path: path2 });
        globalExpect(node.nChildren).toBe(immediateChildren(path2).length);
      }
    });
    it("files carry their own byte size and are childless", async () => {
      ...
      globalExpect(byPath(files.map((c) => ({ path: c.path, size: c.size })))).toEqual(
        byPath(filesUnder("docs/guide").map((k2) => ({ path: k2, size: byteLen(CONFORMANCE_FIXTURE[k2]) })))
      );
    });
    it("is stable across repeated and re-drilled reads", async () => {
      const src = await makeSource();
      const a3 = await src.children({ path: "docs" });
      const b = await src.children({ path: "docs" });
      globalExpect(a3.node).toEqual(b.node);
      const src2 = await makeSource();
      await src2.children();
      const viaRoot = await src2.children({ path: "docs" });
      globalExpect(tuple(viaRoot.node)).toEqual(tuple(a3.node));
    });
  });
}
...
@vitest/snapshot/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=treeConformance.cjs.map